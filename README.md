...
- Supports any terminal: PowerShell, pwsh, Windows Terminal (`wt`), and more
...
|---|---|---|
| Terminal command | `powershell.exe` | The executable to launch. Examples: `powershell.exe`, `pwsh`, `wt` |
